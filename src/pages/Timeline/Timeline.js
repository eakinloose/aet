    ...
    <AboutWrapper>
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <ul>
            <li>
              Leveraged JavaScript with Axios, Mocha, and Chai to develop robust
              API automation frameworks, ensuring comprehensive test coverage
              and end-to-end functional API testing across multiple application
              types, including RBAC-protected systems.
            </li>
            <li>
              Designed and implemented comprehensive test strategies focused on
              critical areas such as transaction flows, security, and
              performance, ensuring high-quality and stable software releases.
            </li>
            <li>
              Collaborated closely with cross-functional teams — including
              backend engineers, frontend developers, and product managers — to
              ensure seamless integration and functionality of all application
              components.
            </li>
            <li>
              Participated in post-release retrospectives, partnering with
              developers to identify lessons learned and apply continuous
              improvement principles to testing processes, tooling, and release
              pipelines.
            </li>
            <li>
              Contributed to fostering a strong culture of quality and
              continuous learning within the team by sharing knowledge, best
              practices, and improving testing standards.
            </li>
          </ul>
        </VerticalTimelineElement>
